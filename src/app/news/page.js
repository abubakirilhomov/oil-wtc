...
const NewsPage = () => {
  ...
  const news = [
    {
      _id: '1',
      title: 'Получите 1000 от Lemarc',
      descriptions: "Новая акция от Lemarc! Участвуйте и получите 1000 бонусов.",
      date: '2024-11-06',
      news_type: 'Акции',
      images: ['https://lemarc.ru/uploads/new_item_images/c87a92174ab7d848b67711e36aab0003.JPG'],
    },
    {
      _id: '2',
      title: 'Lemarc внедряет систему Честный знак',
      descriptions: "Компания Lemarc успешно внедряет новую систему сертификации продукции.",
      date: '2024-10-12',
      news_type: 'Компания',
      images: ['https://lemarc.ru/uploads/new_item_images/f2580392c21648944a6df211bf59b0f5.png'],
    },
  ];

  // Static categories data
  const categories = [
    { _id: '1', category_name: 'Компания' },
    { _id: '2', category_name: 'Партнерство' },
    { _id: '3', category_name: 'Выставки' },
    { _id: '4', category_name: 'Завод' },
    { _id: '5', category_name: 'Спорт' },
    { _id: '6', category_name: 'Продукция' },
    { _id: '7', category_name: 'АКАДЕМИЯ LEMARC' },
    { _id: '8', category_name: 'Акции' },
  ];

  // Filter news based on the selected category
  const filteredNews = selectedCategory
    ? news.filter(item => item.news_type.toLowerCase() === selectedCategory.toLowerCase())
    : news;
