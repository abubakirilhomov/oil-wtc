...
const Dvigitel = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center p-4 lg:p-10 pt-0"> 
      <div className="flex-1 mb-6 lg:mb-0 lg:ml-10"> 
