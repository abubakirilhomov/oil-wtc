...
const CompanyLayout = ({ sections, backgroundImageSrc }) => {
  return (
    <div
      className="container mx-auto my-10 bg-cover bg-center w-full  h-[90vh]"
      style={{
    ...
    >
      ...
      {sections.map((section, index) => (
        <div
          key={index}
          className="lg:mb-12 text-white backdrop-filter lg:py-6 w-full "
        >
          ...
          <div className="w-full lg:mt-[10%] flex">
            <div className="flex overflow-x-auto lg:w-full justify-between">
              {section.details.map((detail, idx) => (
                <div key={idx} className="mt-4 flex-1 min-w-[30%] border-l flex flex-col justify-between lg:max-w-[25%] p-3">
